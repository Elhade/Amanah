    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{filtered.length} don{filtered.length > 1 ? 's' : ''} · Total: {formatAmount(totalFiltered)}</p>
        </div>
        <button
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-2.5 border border-gray-200 rounded-xl text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-400/40 focus:border-emerald-400 bg-white"
            >
              ...
              {filtered.map(d => (
                <div key={d.id} className="px-6 py-4 hover:bg-gray-50 transition-colors">
                  <div className="hidden md:grid grid-cols-7 gap-4 items-center">
                    ...
                    <div className="font-bold text-emerald-600">{formatAmount(d.montant)}</div>
