...
import { HandHeart, CheckCircle, AlertCircle, ChevronRight } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-950 flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl p-8 max-w-md w-full text-center shadow-2xl">
          ...
          <p className="text-gray-500 mb-1">Votre don a été enregistré avec succès.</p>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              ...
              ) : finalAmount > 0 ? `Donner ${finalAmount.toLocaleString('fr-FR')} €` : 'Donner'}
            </button>
